...
public class XCDanmuView extends RelativeLayout {
    ...
    private List<String> mStrContents;
        ...
        public void handleMessage(final Message msg) {
            ...
            animator.setListener(new Animator.AnimatorListener() {
                ...
                public void onAnimationEnd(Animator animator) {
                    ...
                    int index = mRandom.nextInt(100) % mStrContents.size();
                    createDanmuView(pos, mStrContents.get(index), true);
    ...
    int lastRow = 0;
    public void initDanmuItemViews(List<String> strContents){
        mStrContents = strContents;
        for(int i = 0; i < mMaxShowNum; i ++){
            int index =  mRandom.nextInt(100) % strContents.size();
            createDanmuView(i,strContents.get(index),false);
        }
    }
