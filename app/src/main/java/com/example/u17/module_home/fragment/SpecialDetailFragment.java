...
public class SpecialDetailFragment extends BaseFragment {
    ...
    @BindView(R.id.web_view_special_detail)
    WebView mWebView;
     ...
     * @return A new instance of fragment SpecialDetailFragment.
     */
    public static SpecialDetailFragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_special_detail, container, false);
